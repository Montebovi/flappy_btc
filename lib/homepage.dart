...
import 'package:first_game/barriers.dart';
import 'package:first_game/flappy.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  double height = 0;
  double time = 0;
  double gravity = -4.2; // how strong the gravity is
  double velocity = 2.2; // how strong the jump is
  double birdWidth = 0.2; // out of 2, 2 being the entire width of the screen
  double birdHeight = 0.2; // out of 2, 2 being the entire height of the screen
                ...
                child: Center(
                  child: Stack(
                    children: [
                      ...
                      FlappyBird(
                        flappyY: birdY,
                        flappyWidth: birdWidth,
                        flappyHeigth: birdHeight,
                      ),
